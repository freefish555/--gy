...
CREATE TABLE IF NOT EXISTS t_project (
    ...
    system_name_merged  VARCHAR(1000)   DEFAULT NULL COMMENT '系统名称合并，用于模板xtmc',
    sys_count_l2        INT             NOT NULL DEFAULT 0 COMMENT '二级系统数量（自动统计，可手动覆盖）',
    sys_count_l3        INT             NOT NULL DEFAULT 0 COMMENT '三级系统数量（自动统计，可手动覆盖）',
    ...
    electronic_archived TINYINT(1)      NOT NULL DEFAULT 0 COMMENT '电子归档: 0否/1是',
...
CREATE TABLE IF NOT EXISTS t_project_system (
    ...
    sys_level   TINYINT(4)      DEFAULT NULL COMMENT '系统等级: 2/3/4',
    eval_index  VARCHAR(50)     DEFAULT NULL COMMENT '测评指标，如S3A3G3',
